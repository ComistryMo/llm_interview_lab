...
Flickable {
    ...
    ColumnLayout {
        ...
        LabCard {
            ...
            Text { text: "添加一个明确文件"; color: root.colors.text; font.pixelSize: 18; font.bold: true }
            GridLayout {
                width: parent.width
                columns: 2
                columnSpacing: 12
        ...
        RowLayout {
            Layout.fillWidth: true
            Text { text: "材料清单"; color: root.colors.text; font.pixelSize: 18; font.bold: true }
            Item { Layout.fillWidth: true }
            Text { text: app.materials.length + " 条本地记录"; color: root.colors.muted }
        }
        ...
        LabCard {
            ...
            cardColor: root.colors.surface
            borderColor: root.colors.border
            Text { text: "这个学习档案尚未添加材料。"; color: root.colors.text; font.bold: true }
            Text { text: "不添加材料也能使用固定课程和题库模拟面试。"; color: root.colors.muted }
        }
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        ColumnLayout {
                            Layout.fillWidth: true
                            spacing: 2
                            Text { text: modelData.title || "未命名材料"; color: root.colors.text; font.bold: true; font.pixelSize: 16; elide: Text.ElideRight; Layout.fillWidth: true }
                            Text { text: root.materialKindText(modelData.kind) + " · " + root.materialSizeText(modelData.size_bytes); color: root.colors.accent; elide: Text.ElideRight; Layout.fillWidth: true }
                        }
                        StatusPill {
                    ...
                    RowLayout {
                        Layout.fillWidth: true
                        Text { text: "文件已保存在本机；不会自动预览或上传。"; color: root.colors.muted; font.pixelSize: 12; Layout.fillWidth: true; wrapMode: Text.Wrap }
                        ToolButton {
                            id: detailsButton
                    ...
                    ColumnLayout {
                        ...
                        width: parent.width
                        spacing: 3
                        Text { text: "材料 ID：" + modelData.id; color: root.colors.muted; font.pixelSize: 11; elide: Text.ElideRight; Layout.fillWidth: true }
                        Text { text: "相对路径：" + modelData.relative_path; color: root.colors.muted; font.pixelSize: 11; elide: Text.ElideMiddle; Layout.fillWidth: true }
                        Text { text: "SHA-256：" + modelData.sha256; color: root.colors.muted; font.family: "Cascadia Mono"; font.pixelSize: 10; wrapMode: Text.WrapAnywhere; Layout.fillWidth: true }
                        Text {
